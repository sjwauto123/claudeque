...
type Permission struct {
	...
	Type       string `gorm:"type:varchar(20);comment:权限类型" json:"type"`
	Status     int    `gorm:"type:int;comment:0-禁用 1-启用" json:"status"`
	...
	Sort       int    `gorm:"type:int;comment:API排序" json:"sort"`
}
